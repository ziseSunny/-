...
with open('医疗援助时间的敏感性分析.txt','w') as f:
    f.write('%d天医疗援助，最大值为%d，基本控制需要的时间为第%d天\n'%(d_1,round(max1),c1))
    f.write('%d天医疗援助，最大值为%d，基本控制需要的时间为第%d天\n'%(d_2,round(max2),c2))
    f.write('%d天医疗援助，最大值为%d，基本控制需要的时间为第%d天\n'%(d_3,round(max3),c3))
    f.write('%d天医疗援助，最大值为%d，基本控制需要的时间为第%d天\n'%(d_4,round(max4),c4))
    f.write('%d天医疗援助，最大值为%d，基本控制需要的时间为第%d天\n'%(d_5,round(max5),c5))
...
plt.legend(['d3=48','d3=53','d3=58','d3=63','d3=68'])
plt.xlabel('距离2019.12.8的时间')
plt.ylabel('人数/人')
plt.savefig('医疗援助时间对于患者数量的影响.png')
...
plt.plot(time[0,:],I3[0,:],color='red')
plt.plot(time[0,:],I4[0,:],color='skyblue')
plt.legend(['d3=48','d3=53','d3=58','d3=63'])
plt.xlabel('距离2019.12.8的时间')
plt.ylabel('人数/人')
plt.savefig('医疗援助时间对于患者数量的影响_clear.png')